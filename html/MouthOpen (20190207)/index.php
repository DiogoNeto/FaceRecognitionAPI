...
<div id="container">
	...
	<div id="div1" style="display:none;" width="100%" height="100%">
		<table class="table" style="background-color: #F0F0F0;" width="100%" height="500px;">
			<tr>
				<td align="center" width="50%"><div align="right" ><img style="border:5px solid #ff0000; max-height: 500px;" src="./images/img_34.jpg" width="200px"></div></td>
				<td align="center" width="50%"><div align="left"><img style="border:5px solid #00ff00; max-height: 500px;" src="./images/img_70.jpg" width="200px"></div></td>
			<tr>
		</table>
