...
<body>
	...
	<h3 align="center">Boca fechada?</h3>
	...
	<!--<table>
		...
		<form action="index.php" method="POST" id="form1" name="form1" style="visibility: visible;">
			...
			<table align="center" style="margin: 5px;"><tr><td><a href="#" data-toggle="tooltip" title="Caso a rosto que aparece na imagem tenha boca fechada, clique não. Caso o rosto que aparece na imagem tenha a boca aberta, clique sim.">Ajuda?</a></td></tr></table>
		</form>
	</div>	
</body>
</html>